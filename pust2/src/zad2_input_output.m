%% wczytanie funkcji symulujacej obiekt i generacja wektorow bazowych w punkcie pracy
addpath ../
...
for i=1:length(deltas)
    ...
    dlmwrite("../data/zad2/zad2_input_input" + num2str(deltas(i)) + ".csv", input_ts, '\t');
    dlmwrite("../data/zad2/zad2_input_output" + num2str(deltas(i)) + ".csv", output_ts, '\t');
    merged_outputs(i+1,:) = sim_output';
end
hold off
%% zapis wszystkich wyjsc do zbiorczego rysunku
dlmwrite("../data/zad2/zad2_input_outputs_merged.csv", merged_outputs, '\t');