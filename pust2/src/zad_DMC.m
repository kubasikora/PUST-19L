...
% else
    %% zapis do plikow: ZADANIE 5.
      str = strcat('N_', num2str(N), '_Nu_', num2str(Nu), '_lambda_', num2str(lambda), '_D_jump_', num2str(jump), '_Dz_', num2str(Dz),'D_1');
      disp(str)
      ...
      dlmwrite(strcat('../data/zad6/zad6_input_', str, '.csv'), input_ts, '\t');
      dlmwrite(strcat('../data/zad6/zad6_output_', str, '.csv'), output_ts, '\t');
      dlmwrite(strcat('../data/zad6/zad6_stpt_', str, '.csv'), setpoint_ts, '\t');
      dlmwrite(strcat('../data/zad6/zad6_disturbance_', str, '.csv'), disturbance_ts, '\t');
% end