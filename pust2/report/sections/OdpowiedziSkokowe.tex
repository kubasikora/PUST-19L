...
\begin{figure}[t]
    ...
    \begin{axis}[
    width=0.98\textwidth,
    xmin=-1.0,xmax=1,ymin=-2.5,ymax=2.5,
    xlabel={$u$},
    ylabel={$y(u)$},
    legend pos=south east,
    y tick label style={/pgf/number format/1000 sep=},
    ...
    \addlegendentry{$y(u)$},
    \addlegendimage{no markers,red}
    \addplot[red, semithick, thick] file{../data/zad2/zad2_static_char_u.csv};    
    \end{axis}
    \end{tikzpicture}
...
\begin{figure}[b]
    ...
    \begin{axis}[
    width=0.98\textwidth,
    xmin=-1.0,xmax=1,ymin=-1.5,ymax=1.5,
    xlabel={$d$},
    ylabel={$y(d)$},
    legend pos=south east,
    y tick label style={/pgf/number format/1000 sep=},
    ...
    \addlegendentry{$y(d)$},
    \addlegendimage{no markers,red}
    \addplot[red, semithick, thick] file{../data/zad2/zad2_static_char_d.csv};    
    \end{axis}
    \end{tikzpicture}
...
\subsection{Charakterystyka $y(u,z)$}
