...
\part{Projekt}
\label{PROJEKT}
\input{sections/PoprawnoscSygnalow}
\input{sections/OdpowiedziSkokowe}
\input{sections/NormalizacjaOdpowiedzi}
\input{sections/RegulatorDMC}
\input{sections/ZakloceniaProjekt}
\input{sections/SzumPomiarowy}

\part{Laboratorium}
\label{LAB}
\input{sections/PomiarTempPktPracy}
\input{sections/OdpSkokDMC}
\input{sections/ImplementacjaDMC}
\input{sections/StrojenieRegulatoraDMC}
\input{sections/LabWyniki}
