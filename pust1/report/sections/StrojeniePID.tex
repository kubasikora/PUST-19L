...
\begin{figure}[t]
    ...
    \addplot[red, semithick] file{../data/lab/pid/stpt_k=20_ti=1000_td=1.csv};
    \addplot[blue, semithick] file{../data/lab/pid/output_k=20_ti=1000_td=1.csv};
    \addlegendentry{$y^{zad}[k]$},
    \addlegendentry{$y[k]$},
    \addlegendimage{no markers, blue}
	\addlegendimage{no markers, red}
    \end{axis}
    \end{tikzpicture}
    \caption{Przebieg wyjścia obiektu sterowanego regulatora typu PI o wzmocnieniu $K_{\mathrm{r}} = \num{20}, T_{\mathrm{i}} = 1000, T_{\mathrm{d}} = 1$}
    \label{zad5_niegasnace_oscylacje_20_1000}
\end{figure}
...
\begin{figure}[b]
    ...
    \addplot[const plot, blue, semithick] file{../data/lab/pid/input_k=20_ti=1000_td=1.csv};
    \legend{$u[k]$}
    \end{axis}
    \end{tikzpicture}
    \caption{Przebieg sygnału sterującego generowanego przez regulator typu PI o wzmocnieniu $K_{\mathrm{r}} = \num{20}, T_{\mathrm{i}} = 1000, T_{\mathrm{d}} = 1$}
...
\begin{figure}[t]
    ...
    \addplot[red, semithick] file{../data/lab/pid/stpt_k=20_ti=1000_td=5.csv};
    \addplot[blue, semithick] file{../data/lab/pid/output_k=20_ti=1000_td=5.csv};
    \addlegendentry{$y^{zad}[k]$},
    \addlegendentry{$y[k]$},
    \addlegendimage{no markers, blue}
	\addlegendimage{no markers, red}
    \end{axis}
    \end{tikzpicture}
    \caption{Przebieg wyjścia obiektu sterowanego regulatora typu PI o wzmocnieniu $K_{\mathrm{r}} = \num{20}, T_{\mathrm{i}} = 1000, T_{\mathrm{d}} = 5$}
    \label{zad5_niegasnace_oscylacje_20_1000_5}
\end{figure}
...
\begin{figure}[b]
    ...
    \addplot[const plot, blue, semithick] file{../data/lab/pid/input_k=20_ti=1000_td=5.csv};
    \legend{$u[k]$}
    \end{axis}
    \end{tikzpicture}
    \caption{Przebieg sygnału sterującego generowanego przez regulator typu PI o wzmocnieniu $K_{\mathrm{r}} = \num{20}, T_{\mathrm{i}} = 1000, T_{\mathrm{d}} = 5$}
    \label{zad5_niegasnace_oscylacje_ster_20_1000_5}
\end{figure}
\FloatBarrier
...
\begin{figure}[t]
    ...
    \addplot[red, semithick] file{../data/lab/pid/stpt_k=20_ti=1000_td=10.csv};
    \addplot[blue, semithick] file{../data/lab/pid/output_k=20_ti=1000_td=10.csv};
    \addlegendentry{$y^{zad}[k]$},
    \addlegendentry{$y[k]$},
    \addlegendimage{no markers, blue}
	\addlegendimage{no markers, red}
    \end{axis}
    \end{tikzpicture}
    \caption{Przebieg wyjścia obiektu sterowanego regulatora typu PI o wzmocnieniu $K_{\mathrm{r}} = \num{20}, T_{\mathrm{i}} = 1000, T_{\mathrm{d}} = 10$}
...
\begin{figure}[b]
    ...
    \addplot[const plot, blue, semithick] file{../data/lab/pid/input_k=20_ti=1000_td=10.csv};
    \legend{$u[k]$}
    \end{axis}
    \end{tikzpicture}
    \caption{Przebieg sygnału sterującego generowanego przez regulator typu PI o wzmocnieniu $K_{\mathrm{r}} = \num{20}, T_{\mathrm{i}} = 1000, T_{\mathrm{d}} = 10$}
    \label{zad5_niegasnace_oscylacje_ster_20_1000_10}
\end{figure}
\FloatBarrier