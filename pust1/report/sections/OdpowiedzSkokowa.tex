...
\begin{figure}[h]
    ...
    \addlegendentry{$\Delta$ o 0,05},
    \addlegendentry{$\Delta$ o 0,10},
    \addlegendentry{$\Delta$ o 0,15},
    \addlegendentry{$\Delta$ o 0,20},
    \addlegendentry{$\Delta$ o -0,05},
    \addlegendentry{$\Delta$ o -0,10},
    \addlegendentry{$\Delta$ o -0,15},
    \addlegendentry{$\Delta$ o -0,20},
...
Na powyższym wykresie możemy zaobserwować, że wraz z wzrostem wartości skoku rośnie również wartość odpowiedzi procesu y(t). Jest to zachowanie zgodne z naszymi oczekiwaniami przed rozpoczęciem eksperymentu.
