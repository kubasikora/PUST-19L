...
\input{sections/OdpowiedzSkokowa}
\input{sections/NormalizacjaOpowiedzi}
\input{sections/BudowaProgramow}
\input{sections/RegulatorPID}
\input{sections/RegulatorDMC}
\input{sections/Optymalizacja}

\part{Laboratorium}
\label{LABORATORIUM}
\input{sections/ObiektLaboratoryjny}
\input{sections/ModelowanieObiektu}
\input{sections/StrojeniePID}
\input{sections/StrojenieDMC}
