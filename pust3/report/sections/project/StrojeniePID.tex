...
\begin{figure}[t]
    ...
    \addplot[red, semithick] file{../data/project/zad4/zad3PID_output_K_0.15_Ti_7.25_Td_1.74.csv};  
    \addplot[blue, semithick] file{../data/project/zad4/zad3PID_setpoint_K_0.15_Ti_7.25_Td_1.74.csv};
...
\begin{figure}[b]
    ...
    \addplot[blue, semithick] file{../data/project/zad4/zad3PID_input_K_0.15_Ti_7.25_Td_1.74.csv};
...
\begin{figure}[b]
    ...
    \begin{axis}[
    width=0.98\textwidth,
    xmin=0.0,xmax=1000,ymin=-0.5,ymax=1.1,
    xlabel={$k$},
    ylabel={$y[k]$},
    legend pos=south east,
    y tick label style={/pgf/number format/1000 sep=},
